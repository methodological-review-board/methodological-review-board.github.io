...
The MRB was established to support researchers precisely at this stage of the workflow. Its role is to provide structured guidance on research questions, design, sampling, measurement and analysis planning within a pre-registration framework. At the same time, the MRB acknowledges that producing a clear and coherent pre-registration is demanding and often requires substantial methodological expertise. For this reason, the MRB prioritises improving clarity and transparency in pre-registrations, rather than offering exhaustive support on every possible detail.
